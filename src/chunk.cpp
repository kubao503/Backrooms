    ...
    : position_(position)
{
    ...
    {
    case 1:
        wallNorth = std::make_unique<Object3D>(world, Object::ObjectType::WALL, wallNorthPosition, 0);
        break;
    case 2:
        wallWest = std::make_unique<Object3D>(world, Object::ObjectType::WALL, wallWestPosition, PI / 2);
        break;
    case 3:
        wallNorth = std::make_unique<Object3D>(world, Object::ObjectType::WALL, wallNorthPosition, 0);
        wallWest = std::make_unique<Object3D>(world, Object::ObjectType::WALL, wallWestPosition, PI / 2);
...
void Chunk::restore(b2World &world)
{
    ...
    if (wallNorth)
    {
        ...
        b2Vec2 wallNorthPosition = b2Vec2(position_.x + 5.0f, position_.y);
        wallNorth->setBody(world, Object::ObjectType::WALL, wallNorthPosition, 0);
    }

    if (wallWest)
    {
        b2Vec2 wallWestPosition = b2Vec2(position_.x + 10.0f, position_.y + 5.0f);
        wallWest->setBody(world, Object::ObjectType::WALL, wallWestPosition, PI / 2);
    }
}
